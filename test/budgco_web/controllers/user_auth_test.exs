defmodule BudgcoWeb.UserAuthTest do
  use BudgcoWeb.ConnCase, async: true

  alias Budgco.Accounts
  alias BudgcoWeb.UserAuth
  import Budgco.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BudgcoWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BudgcoWeb.Endpoint.subscribe(live_socket_id)
